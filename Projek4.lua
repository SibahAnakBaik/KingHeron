...
local function notify(msg)
    StarterGui:SetCore("SendNotification", {Title = "PrrI anti afz", Text = msg, Duration = 4})
end
...
toggleBtn.Image = "rbxassetid://116982444162170"
...
title.Text = "⚡ PrrI anti afz Brookhaven"
...
boxStroke.Color = Color3.fromRGB(0,255,100)
...
listBtn.BackgroundColor3 = Color3.fromRGB(22,22,22)
listBtn.Text = "📋 Players List"
listBtn.TextColor3 = Color3.fromRGB(0,255,100)
...
listBtnStroke.Color = Color3.fromRGB(0,255,100)
...
flingBtn.BackgroundColor3 = Color3.fromRGB(0,50,0)
...
fStroke.Color = Color3.fromRGB(50,255,50)
fStroke.Thickness = 2
...
viewBtn.BackgroundColor3 = Color3.fromRGB(0,0,60)
viewBtn.Text = "View"
...
vStroke.Color = Color3.fromRGB(50,50,255)
vStroke.Thickness = 2

-- LIST PLAYER POPUP (fix + auto update)
local listGui = nil
local function showPlayerList()
    ...
    listCloseBtn.BackgroundColor3 = Color3.fromRGB(220,40,60)
...
local function SkidFling(TargetPlayer)
    ...
    if success then
        notify("Kill sukses ke " .. TargetPlayer.Name)
    else
        notify("Kill gagal: " .. tostring(result))
    end
end
...
notify("PrrI anti afz FULL Loaded! Siap gaspol woi! 🥵🔥")